...
![Learned SPDE Parameter: Local variance τ](/assets/images/post_SPDE/NATL_params_tau.png)
![Learned SPDE Parameter: Meridional advection m₁](/assets/images/post_SPDE/NATL_params_m1.png)
![Learned SPDE Parameter: Meridional diffusion H₁₁](/assets/images/post_SPDE/NATL_params_H22.png)
...
*Ground truth and three posterior ensemble member for a 2-day forecast over the Global domain, with three subdomains highlighted (red boxes) corresponding to the Gulf Stream, Agulhas, and Kuroshio currents*
